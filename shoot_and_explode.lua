...
function wandPosInWorld()
	return RelativeTo.World:getInverseMatrix():preMult(wand.position)
end

function removeObjectFromShootableObjectsTable(obj)
	local idx = nil
...
function getNewExplodeFunction(object)
...
function createActionFrameForEachShootableObject(laser)
...
function createProjectileMotionActionFrame(xform,scale,gravity)
...
function enableShootableObjects()
